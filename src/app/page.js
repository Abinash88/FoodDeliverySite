...
import { ArchiveBoxIcon, HandRaisedIcon, MagnifyingGlassIcon, TruckIcon } from '@heroicons/react/24/solid'
...
export default function Home() {
  ...
  return (
    <main className="flex-1 w-full bg-gray-100">
      <div className='topMiddleHeader flex justify-between items-center w-[90%] mx-auto mt-10'>
